...
/**
 * Main UI state for the Cribbage game.
 * Immutable data class representing all game state exposed to the UI layer.
 */
data class GameUiState(
    ...
    // Player/Opponent scores and dealer status
...
/**
 * State specific to the pegging phase of the game.
 */
...
/**
 * State specific to the hand counting phase.
 */
...
/**
 * Match statistics tracked across games.
 */
...
/**
 * Data for the winner modal display.
 */
...
/**
 * State for pending pegging round reset acknowledgment.
 */
...
/**
 * Data for a sub-round reset in pegging.
 */
data class SubRoundReset(
    val reason: String,
    val playerCardsRemaining: Int,
    val opponentCardsRemaining: Int,
    val nextPlayerIsPlayer: Boolean
)
